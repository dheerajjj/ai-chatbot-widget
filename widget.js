...
// Initialize widget functionality
  console.log('[AI Widget] Initializing widget...');
...
function init() {
    console.log('[AI Widget] DOM ready state:', document.readyState);
    ...
    createStyles();
console.log('[AI Widget] Creating widget elements...');
    const widget = createWidget();
if (widget) {
      console.log('[AI Widget] Widget created, initializing...');
      initWidget(widget);
    } else {
      console.error('[AI Widget] Widget creation failed.');
    }
  }
